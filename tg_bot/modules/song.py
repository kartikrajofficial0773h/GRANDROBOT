...
async def download_video(v_url):  
    ...
    if song:
        ...
        await rkp.edit(f"`Preparing to upload video song by using KINGBOT.. :`\
        \n**{rip_data['title']}**\
        \nby *{rip_data['uploader']}*")
        await v_url.client.send_file(
            v_url.chat_id,
...
__help__ = """
 ...
 ➩ /video <songname artist(optional)>: uploads the video song in it's best quality available by KINGBOT
"""
